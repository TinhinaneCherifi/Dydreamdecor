...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\ContainerMEVdgtk\App_KernelDevDebugContainer::class, null);
require __DIR__.'/ContainerMEVdgtk/EntityManager_9a5be93.php';
require __DIR__.'/ContainerMEVdgtk/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/ContainerMEVdgtk/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/ContainerMEVdgtk/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/ContainerMEVdgtk/getVichUploader_UploadHandlerService.php';
require __DIR__.'/ContainerMEVdgtk/getVichUploader_Form_Type_ImageService.php';
require __DIR__.'/ContainerMEVdgtk/getVichUploader_Form_Type_FileService.php';
require __DIR__.'/ContainerMEVdgtk/getVichUploader_DownloadHandlerService.php';
require __DIR__.'/ContainerMEVdgtk/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerMEVdgtk/getValidator_ExpressionService.php';
require __DIR__.'/ContainerMEVdgtk/getValidator_EmailService.php';
require __DIR__.'/ContainerMEVdgtk/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerMEVdgtk/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerMEVdgtk/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerMEVdgtk/getTwig_Mailer_MessageListenerService.php';
require __DIR__.'/ContainerMEVdgtk/getTwig_Form_RendererService.php';
require __DIR__.'/ContainerMEVdgtk/getTranslation_Loader_YmlService.php';
require __DIR__.'/ContainerMEVdgtk/getTranslation_Loader_XliffService.php';
require __DIR__.'/ContainerMEVdgtk/getTranslation_Loader_ResService.php';
require __DIR__.'/ContainerMEVdgtk/getTranslation_Loader_QtService.php';
require __DIR__.'/ContainerMEVdgtk/getTranslation_Loader_PoService.php';
require __DIR__.'/ContainerMEVdgtk/getTranslation_Loader_PhpService.php';
require __DIR__.'/ContainerMEVdgtk/getTranslation_Loader_MoService.php';
require __DIR__.'/ContainerMEVdgtk/getTranslation_Loader_JsonService.php';
require __DIR__.'/ContainerMEVdgtk/getTranslation_Loader_IniService.php';
require __DIR__.'/ContainerMEVdgtk/getTranslation_Loader_DatService.php';
require __DIR__.'/ContainerMEVdgtk/getTranslation_Loader_CsvService.php';
require __DIR__.'/ContainerMEVdgtk/getSession_FactoryService.php';
require __DIR__.'/ContainerMEVdgtk/getServicesResetterService.php';
require __DIR__.'/ContainerMEVdgtk/getSerializer_Mapping_ClassMetadataFactoryService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_UserPasswordHasherService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_User_Provider_Concrete_AppUserProviderService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_Logout_Listener_Default_MainService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_HttpUtilsService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_AuthenticationUtilsService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_AccessMapService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerMEVdgtk/getSecrets_VaultService.php';
require __DIR__.'/ContainerMEVdgtk/getRouting_LoaderService.php';
require __DIR__.'/ContainerMEVdgtk/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerMEVdgtk/getPropertyAccessorService.php';
require __DIR__.'/ContainerMEVdgtk/getMimeTypesService.php';
require __DIR__.'/ContainerMEVdgtk/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerMEVdgtk/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/ContainerMEVdgtk/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/ContainerMEVdgtk/getForm_TypeExtension_Upload_ValidatorService.php';
require __DIR__.'/ContainerMEVdgtk/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/ContainerMEVdgtk/getForm_TypeExtension_Form_TransformationFailureHandlingService.php';
require __DIR__.'/ContainerMEVdgtk/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/ContainerMEVdgtk/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/ContainerMEVdgtk/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/ContainerMEVdgtk/getForm_Type_FormService.php';
require __DIR__.'/ContainerMEVdgtk/getForm_Type_EntityService.php';
require __DIR__.'/ContainerMEVdgtk/getForm_Type_ColorService.php';
require __DIR__.'/ContainerMEVdgtk/getForm_Type_ChoiceService.php';
require __DIR__.'/ContainerMEVdgtk/getForm_ServerParamsService.php';
require __DIR__.'/ContainerMEVdgtk/getForm_RegistryService.php';
require __DIR__.'/ContainerMEVdgtk/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/ContainerMEVdgtk/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/ContainerMEVdgtk/getErrorControllerService.php';
require __DIR__.'/ContainerMEVdgtk/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerMEVdgtk/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerMEVdgtk/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerMEVdgtk/getDoctrine_Orm_Listeners_PdoCacheAdapterDoctrineSchemaSubscriberService.php';
require __DIR__.'/ContainerMEVdgtk/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaSubscriberService.php';
require __DIR__.'/ContainerMEVdgtk/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaSubscriberService.php';
require __DIR__.'/ContainerMEVdgtk/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerMEVdgtk/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerMEVdgtk/getDoctrine_Migrations_ContainerAwareMigrationsFactoryService.php';
require __DIR__.'/ContainerMEVdgtk/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerMEVdgtk/getDebug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerMEVdgtk/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerMEVdgtk/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurityVoterService.php';
require __DIR__.'/ContainerMEVdgtk/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/ContainerMEVdgtk/getDebug_Security_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerMEVdgtk/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/ContainerMEVdgtk/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerMEVdgtk/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerMEVdgtk/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerMEVdgtk/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerMEVdgtk/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerMEVdgtk/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerMEVdgtk/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerMEVdgtk/getBatchActionDtoResolverService.php';
require __DIR__.'/ContainerMEVdgtk/getAdminContextResolverService.php';
require __DIR__.'/ContainerMEVdgtk/getDataCollector_Request_SessionCollectorService.php';
require __DIR__.'/ContainerMEVdgtk/getContainer_GetenvService.php';
require __DIR__.'/ContainerMEVdgtk/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerMEVdgtk/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerMEVdgtk/getCache_SystemClearerService.php';
require __DIR__.'/ContainerMEVdgtk/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerMEVdgtk/getCache_AppClearerService.php';
require __DIR__.'/ContainerMEVdgtk/getTransliteratorService.php';
require __DIR__.'/ContainerMEVdgtk/getUniqidNamerService.php';
require __DIR__.'/ContainerMEVdgtk/getSubdirDirectoryNamerService.php';
require __DIR__.'/ContainerMEVdgtk/getSmartUniqueNamerService.php';
require __DIR__.'/ContainerMEVdgtk/getPropertyNamerService.php';
require __DIR__.'/ContainerMEVdgtk/getPropertyDirectoryNamerService.php';
require __DIR__.'/ContainerMEVdgtk/getOrignameNamerService.php';
require __DIR__.'/ContainerMEVdgtk/getHashNamerService.php';
require __DIR__.'/ContainerMEVdgtk/getCurrentDateTimeDirectoryNamerService.php';
require __DIR__.'/ContainerMEVdgtk/getBase64NamerService.php';
require __DIR__.'/ContainerMEVdgtk/getTemplateControllerService.php';
require __DIR__.'/ContainerMEVdgtk/getRedirectControllerService.php';
require __DIR__.'/ContainerMEVdgtk/getFieldProviderService.php';
require __DIR__.'/ContainerMEVdgtk/getEntityUpdaterService.php';
require __DIR__.'/ContainerMEVdgtk/getEntityRepositoryService.php';
require __DIR__.'/ContainerMEVdgtk/getFiltersFormTypeService.php';
require __DIR__.'/ContainerMEVdgtk/getFileUploadTypeService.php';
require __DIR__.'/ContainerMEVdgtk/getCrudFormTypeService.php';
require __DIR__.'/ContainerMEVdgtk/getEaCrudFormTypeExtensionService.php';
require __DIR__.'/ContainerMEVdgtk/getSlugConfiguratorService.php';
require __DIR__.'/ContainerMEVdgtk/getNumberConfiguratorService.php';
require __DIR__.'/ContainerMEVdgtk/getMoneyConfiguratorService.php';
require __DIR__.'/ContainerMEVdgtk/getDateTimeConfiguratorService.php';
require __DIR__.'/ContainerMEVdgtk/getCountryConfiguratorService.php';
require __DIR__.'/ContainerMEVdgtk/getCommonPreConfiguratorService.php';
require __DIR__.'/ContainerMEVdgtk/getCommonPostConfiguratorService.php';
require __DIR__.'/ContainerMEVdgtk/getChoiceConfiguratorService.php';
require __DIR__.'/ContainerMEVdgtk/getBooleanConfiguratorService.php';
require __DIR__.'/ContainerMEVdgtk/getAssociationConfiguratorService.php';
require __DIR__.'/ContainerMEVdgtk/getPaginatorFactoryService.php';
require __DIR__.'/ContainerMEVdgtk/getFormFactoryService.php';
require __DIR__.'/ContainerMEVdgtk/getFilterFactoryService.php';
require __DIR__.'/ContainerMEVdgtk/getExceptionListenerService.php';
require __DIR__.'/ContainerMEVdgtk/getCrudResponseListenerService.php';
require __DIR__.'/ContainerMEVdgtk/getProfilerControllerService.php';
require __DIR__.'/ContainerMEVdgtk/getLoginFormAuthenticatorService.php';
require __DIR__.'/ContainerMEVdgtk/getUserRepositoryService.php';
require __DIR__.'/ContainerMEVdgtk/getItemRepositoryService.php';
require __DIR__.'/ContainerMEVdgtk/getItemCategoryRepositoryService.php';
require __DIR__.'/ContainerMEVdgtk/getRegistrationFormTypeService.php';
require __DIR__.'/ContainerMEVdgtk/getChangePasswordTypeService.php';
require __DIR__.'/ContainerMEVdgtk/getSecurityControllerService.php';
require __DIR__.'/ContainerMEVdgtk/getRegistrationControllerService.php';
require __DIR__.'/ContainerMEVdgtk/getItemControllerService.php';
require __DIR__.'/ContainerMEVdgtk/getHomeControllerService.php';
require __DIR__.'/ContainerMEVdgtk/getUserCrudControllerService.php';
require __DIR__.'/ContainerMEVdgtk/getItemCrudControllerService.php';
require __DIR__.'/ContainerMEVdgtk/getItemCategoryCrudControllerService.php';
require __DIR__.'/ContainerMEVdgtk/getDashboardControllerService.php';
require __DIR__.'/ContainerMEVdgtk/getAccountPasswordControllerService.php';
require __DIR__.'/ContainerMEVdgtk/getAccountControllerService.php';
require __DIR__.'/ContainerMEVdgtk/get_Session_DeprecatedService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_Q6hAO0Service.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_L2QwsaZService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_IpvtXDOService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_BgOZrService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_9ywsWService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_ZOQ9v2dService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_UDgw6OlService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_U4BbnsnService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_SxWgT3IService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_OlybskbService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_Nt_OgDbService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_KfwZsneService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_KfbR3DYService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_GNc8e5BService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_CKlWSjaService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_4u5os03Service.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_4C0Bh8jService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_3on9uHLService.php';
require __DIR__.'/ContainerMEVdgtk/get_ServiceLocator_2dc0eaXService.php';
require __DIR__.'/ContainerMEVdgtk/get_Container_Private_SessionService.php';
require __DIR__.'/ContainerMEVdgtk/get_Container_Private_SerializerService.php';
require __DIR__.'/ContainerMEVdgtk/get_Container_Private_Form_Type_FileService.php';
require __DIR__.'/ContainerMEVdgtk/get_Container_Private_Form_FactoryService.php';
require __DIR__.'/ContainerMEVdgtk/get_Container_Private_FilesystemService.php';
require __DIR__.'/ContainerMEVdgtk/get_Container_Private_CacheClearerService.php';
...
$classes[] = 'App\Controller\Admin\ItemCategoryCrudController';
...
$classes[] = 'App\Repository\ItemCategoryRepository';
